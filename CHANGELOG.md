...
## v0.52.0 - 多平台内容入口与可学习 AI 提示词反馈 - 2026-09-09（源码已推送，未创建 Release）
...
发布状态：v0.52.0 源码已 commit 并推送到 `origin/master`，未创建 tag/Release 或部署；当前公开版本仍为 [OmniBlock v0.46.2](https://github.com/a2787/ub-utils/releases/tag/v0.46.2)。
