...
(async function () {
  ...
  GM_addStyle(`
    ...
    /* 上面的 .ob-ai-key-row/.ob-sync-actions 等组件规则比触控块的通用按钮规则更具体，
       会把面板紧凑按钮和审核/反馈浮层的 foot、拒绝、作用域按钮压回 26–34px；
       触控设备在组件规则之后统一恢复 44px 触控目标。 */
    @media (pointer: coarse), (any-pointer: coarse), (hover: none), (any-hover: none) {
      ...
      #ob-ai-review .ob-ai-review-foot button, #ob-ai-review .ob-ai-reject,
      #ob-ai-review .ob-ai-candidate-scope, #ob-ai-feedback .ob-ai-feedback-foot button {
        min-height: 44px;
      }
      #ob-ai-review .ob-ai-close, #ob-ai-feedback .ob-ai-feedback-close { width: 44px; height: 44px; min-height: 44px; }
    }
