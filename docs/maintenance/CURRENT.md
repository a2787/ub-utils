...
- 最近验证的源码快照：`50f2a518108b6e54780d3f67d2971a82c5b7cf39`
- 当前候选源码 SHA-256：`5d35915685140dc7fc33f64a1c156a8d6ef6f72231134f53b32f00de0c7c6801`
- 候选状态：`OB-WEIBO-002` 源码与回归测试已提交到本地 `50f2a51`；用户在专用浏览器体验后要求继续收口，当前仍未公开发布。
...
0.46.0 当前工作区结构矩阵 122/122；userscript、评论管理器、自动弹幕、作品级屏蔽和已安装浏览器探针语法通过；
